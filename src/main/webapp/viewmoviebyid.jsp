...
.card-image img {
    ...
    height: 350px;
    display: block;
    border-radius: 28px; /* Adjust the border radius for smoothness */
    border: 1px solid #e5e5e5; /* Add a border with a color of your choice */
}
...
.profile-description {
    max-height: 140px; /* Adjust the max height as needed */
...
<body>
    ...
    <div class="movies-row">
        <div class="movie-card">
            <div class="card-image">
                <img src='displayproductimage?id=${j.id}' alt="Movie Poster">
            </div>
            <div class="card-details">
                <div class="profile-name"><b>Role :</b> ${j.title}</div>
                <br>	
                <div class="profile-genre"><b>Genre :</b> ${j.genre}</div>
                <div class="profile-description"><b>Description :</b> ${j.description}</div>
                <div class="profile-date"><b>Date :</b> ${j.releaseDate}</div>
               <form action="/addtomyplaylist" method="post" class="add-to-playlist-form">
    <input type="hidden" name="movieId" value="${j.id}">
    ...
    <script>
        ...
        function redirectToMovieDetails(movieId) {
            ...
            var movieDetailsUrl = "/movie-details?id=" + movieId;
